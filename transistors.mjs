...
let transistor = (_id, _points) => { id: _id, points: _points };

// (define-struct link
//   (point position) #:transparent)
let link = (_point, _position) => { point: _point, position: _position };
...
let filter_transistor = (id, g) => {
  for(var ii = 0; ii < g.length; ii++) {
    if(g[ii].transistor_id === id) return g[ii];
  }
...
export let pdn = () => [
  make_transistor('A', 'P2',  'Vdd'),
  make_transistor('D', 'P1',  'Vdd'),
  make_transistor('E', 'P2',  'P1' ),
  make_transistor('B', 'Out', 'P2' ),
...
export let pdn = () => [
  make_transistor('A', 'Out', 'P3' ),
  make_transistor('D', 'P3',  'Vss'),
  make_transistor('E', 'P3',  'Vss'),
  make_transistor('B', 'Out', 'P4' ),
...
export let pud2 = () => [
  make_transistor('A', 'P1',  'Vdd'),
  make_transistor('B', 'P1',  'Vdd'),
  make_transistor('E', 'P2',  'P1' ),
  make_transistor('D', 'Out', 'P2' ),
  make_transistor('C', 'Out', 'P2' )
];
...
export let pdn2 = () => [
  make_transistor('A', 'Out', 'P3' ),
  make_transistor('B', 'P3',  'Vss'),
  make_transistor('E', 'Out', 'Vss'),
  make_transistor('D', 'Out', 'P4' ),
  make_transistor('C', 'P4',  'Vss')
];
...
export let pud3 = () => [
  make_transistor('A', 'P1',  'Vdd'),
  make_transistor('B', 'P1',  'Vdd'),
  make_transistor('C', 'P1',  'Vdd'),
  make_transistor('D', 'Out', 'P1' ),
...
export let pdn3 = () => [
  make_transistor('A', 'Out', 'P2' ),
  make_transistor('B', 'P2',  'P3' ),
  make_transistor('C', 'P3',  'Vss'),
  make_transistor('D', 'P4',  'Vss'),
